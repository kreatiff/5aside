...
Candidates passed into `matchPlayerByAlias` _must always_ include:
...
## Manual Transactions Bypass

Transactions created via the "Manual Adjustment" feature (assigned directly to a player or venue category) **bypass** the reconciliation engine and queue entirely, as they are explicitly categorized at the point of creation.
